...
export const MobileFolderItem = (props: Folder) => {
  ...
  const onClick = openModal({
    ...
    title: 'Delete Folder?',
    onConfirm: () => deleteFolder(props.folder_id)
  })
  ...
  return (
    ...
    >
      ...
      <span onClick={onClick} className='hidden group-hover:block transition-all ml-auto'>
